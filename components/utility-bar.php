<?php
/**
 * Utility Bar — top bar with contact email and social icons
 */
?>
<div class="utility-bar">
  <div class="utility-bar__inner">
    <div class="utility-bar__date">
      <a href="mailto:<?= htmlspecialchars(FXTOPICS_EMAIL) ?>" class="utility-bar__email">
        <i data-lucide="mail" class="utility-bar__email-icon" aria-hidden="true"></i>
        <span><?= htmlspecialchars(FXTOPICS_EMAIL) ?></span>
      </a>
    </div>
    <div class="utility-bar__right">
      <div class="utility-bar__social" aria-label="Social media">
